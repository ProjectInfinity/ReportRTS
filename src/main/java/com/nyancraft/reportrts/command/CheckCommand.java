    ...
    private void checkId(int id, CommandSender sender){
        ...
        if(currentRequest == null) {
            ...
            try {
                ...
                sender.sendMessage(ChatColor.YELLOW + "Filed by" + online + " " + rs.getString("name") + ChatColor.YELLOW + " at " +  ChatColor.GREEN + date + ChatColor.YELLOW + " at X:" + ChatColor.GREEN + rs.getInt("x") + ChatColor.YELLOW + ", Y:" + ChatColor.GREEN + rs.getInt("y") + ChatColor.YELLOW + ", Z:" + ChatColor.GREEN + rs.getInt("z"));
